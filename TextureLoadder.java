...
/**
 * Loadder textures depends from coordinates.
 */
...
public class TextureLoadder {
    ...
    public Pane loadSentPane(int whichX, int whichY) {
        ...
        localImage.setViewport(
            new Rectangle2D(whichX * textureSize, whichY * textureSize, textureSize, textureSize));
    ...
    public ImageView loadSentImageView(Vec2d getVect) {
        ImageView localImage = new ImageView(mainTexture);
        localImage.setViewport(
            new Rectangle2D(getVect.x * textureSize, getVect.y * textureSize, textureSize,
                textureSize));
        return localImage;
    }
}
